          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <h3 className="font-playfair text-2xl font-bold mb-4">
                Beleza <span className="text-gold">Digital</span>
              </h3>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    ...
                    className="flex items-center gap-2 text-background/70 hover:text-gold transition-colors text-sm"
                  >
                ...
                <li>
                  <a
                    href="https://instagram.com/belezadigital"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-background/70 hover:text-gold transition-colors text-sm"
                  >
                ...
                <li>
                  <a
                    href="mailto:contato@belezadigital.com"
                    className="flex items-center gap-2 text-background/70 hover:text-gold transition-colors text-sm"
                  >
